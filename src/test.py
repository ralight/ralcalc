...
tests = [
    ...
    RalcalcTest(["1++2"], expected_stderr="\nError: 1++2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1+*2"], expected_stderr="\nError: 1+*2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1+x2"], expected_stderr="\nError: 1+x2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1+/2"], expected_stderr="\nError: 1+/2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1+^2"], expected_stderr="\nError: 1+^2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1+%2"], expected_stderr="\nError: 1+%2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1*+2"], expected_stderr="\nError: 1*+2\n         ^ invalid operator", expected_rc=1),
    ...
    RalcalcTest(["1*^2"], expected_stderr="\nError: 1*^2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1*%2"], expected_stderr="\nError: 1*%2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1x+2"], expected_stderr="\nError: 1x+2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1x*2"], expected_stderr="\nError: 1x*2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1xx2"], expected_stderr="\nError: 1xx2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1x/2"], expected_stderr="\nError: 1x/2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1x^2"], expected_stderr="\nError: 1x^2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1x%2"], expected_stderr="\nError: 1x%2\n         ^ invalid operator", expected_rc=1),
    RalcalcTest(["1/+2"], expected_stderr="\nError: 1/+2\n         ^ invalid operator", expected_rc=1),
    ...
    RalcalcTest(["si"], expected_stderr="\nError: si\n       ^ unknown token\n\nError: si\n        ^ unknown token", expected_rc=1),
    RalcalcTest(["co"], expected_stderr="\nError: co\n       ^ unknown token\n\nError: co\n        ^ unknown token", expected_rc=1),
    RalcalcTest(["ta"], expected_stderr="\nError: ta\n       ^ unknown token\n\nError: ta\n       ^ bad number", expected_rc=1),
    RalcalcTest(["l"], expected_stderr="\nError: l\n       ^ unknown token", expected_rc=1),
    RalcalcTest(["s"], expected_stderr="\nError: s\n       ^ unknown token", expected_rc=1),
    RalcalcTest(["c"], expected_stderr="\nError: c\n       ^ unknown token", expected_rc=1),
